...
** Status bar
   :PROPERTIES:
   :header-args:scheme: :tangle ~/.status/status.scm
   :header-args:scheme+: :tangle-mode (identity #o755)
   :END:
   ...
   #+BEGIN_SRC scheme :session status
...
** Xinit
   ...
   #+BEGIN_SRC sh :tangle ~/.xinitrc :noweb yes
