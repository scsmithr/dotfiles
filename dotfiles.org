...
* Git
  ...
  way of denoting headers, and I have never seen it used beyond examples.
...
*** Xmonad
    ...
    Window manager configuration. The keybinds have been modified to support a
    reflected tall layout (main window on the right).
    ...
    #+BEGIN_SRC haskell :tangle ~/.xmonad/xmonad.hs :noweb yes
      ...
      myLayoutHook =
        ...
        where
          tall = reflectHoriz $ Tall 1 (5 / 100) (13 / 20)
          gs = 5
